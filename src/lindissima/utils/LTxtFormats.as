...
/*
 * Container for lindissima text formats
 * 
 * @author Max pimm
 * @created 09-09-2005
 * @version 1.0
 */
 class lindissima.utils.LTxtFormats {
	...
	public var marbleTxtFormat:TextFormat;
	public var lakeModelXAxisTxtFormat:TextFormat;
	public var storyTxtFormat:TextFormat;
	public var softTitleTxtFormat:TextFormat;

	function LTxtFormats(){
		...
		//init marble text format
		marbleTxtFormat = new TextFormat();
		marbleTxtFormat.size = 10;
		marbleTxtFormat.font = "Arial";
		
		//init lake model xAxis text format
		lakeModelXAxisTxtFormat = new TextFormat();
		lakeModelXAxisTxtFormat.size = 12;
		lakeModelXAxisTxtFormat.font = "Arial bold";
		lakeModelXAxisTxtFormat.bold = true;
		lakeModelXAxisTxtFormat.align = "center";
		lakeModelXAxisTxtFormat.color = Const.DEFAULT_BORDER_COLOR;
